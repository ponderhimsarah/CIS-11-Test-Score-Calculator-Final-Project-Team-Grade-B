...
SECONDLOOP LDR R3, R1, #0	;Access USERG pointer value
NOT R5, R5
ADD R5, R5, #1
ADD R3, R3, R5
BRp MOVETWO
...
DECIMALD		.FILL #-48
SYMD			.FILL #48
THIRD			.FILL #-30		;MIGHT NOT BE NEEDED?
TOTALTESTS		.FILL 5
SECONDR		.FILL x3000
...
PNTR	.FILL	x4000	;POINTER START LOCATION - CHANGE NOTE
